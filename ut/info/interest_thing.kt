    ...
    fun createText(location: Int, count: Int, text:List<String>, TextView: TextView?=null ,bool:Boolean=true,index:Int=0) {
        ...
        for (i in 0 until count){
            ...
            if(bool){
                ...
                newTextView.setTextColor(Color.parseColor("#009688"))
                newTextView.setTypeface(null, Typeface.BOLD)

                for(j in 0 until select_ca_0.size){
                    if(text[i]==select_ca_0[j]){
                        newTextView.setTypeface(null, Typeface.NORMAL)
                    }
                }
                ...
                newTextView.setOnClickListener {
                    ...
                    if(select_ca.contains(classification[index])){
                        TextView!!.setTypeface(null, Typeface.NORMAL)//폰트, 스타일
                    }else{
