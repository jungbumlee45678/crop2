...
class purchase_history : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val search = com.example.ut.a_data.search("purchase", userid, "", 0)
                ...
                if (response.isSuccessful) {
                    ...
                    if(responseBody!!.items.isNotEmpty()){
                        ...
                        for(i in 0 until responseBody!!.items.size){
                            val linearLayout1 = LinearLayout(this@purchase_history)
                            ...
                            val linear = LinearLayout(this@purchase_history)
                            ...
                            val view = ImageView(this@purchase_history)
                            ...
                            Glide.with(this@purchase_history)
                            ...
                            view.setOnClickListener {
                                ...
                                val webView = WebView(this@purchase_history)
                            ...
                            val innerLayout = LinearLayout(this@purchase_history)
                            layoutParams = LinearLayout.LayoutParams(
                            ...
                            val titleTextView = TextView(this@purchase_history)
                            ...
                            val addressTextView = TextView(this@purchase_history)
                            ...
                            val creditTextView = TextView(this@purchase_history)
                            ...
                            val viewsTextView = TextView(this@purchase_history)
                            ...
                            val newlin = LinearLayout(this@purchase_history)
                        ...
                        val TextView = TextView(this@purchase_history)
                        TextView.text = "구매 내역이 없습니다"
