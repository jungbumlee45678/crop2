...
interface ApiServer {
    ...
    @POST("/change_address")
    fun ch_address(@Body userData: change_address): Call<String>
    ...
    @POST("/board")
    fun filter_board(@Body userData : filter_search): Call<board>

    @POST("/re_board")
    fun re_board(@Body usreDate: re_board):Call<String>
    ...
    @POST("/board_delete")
    fun board_delete(@Body userData : board_num): Call<String>
